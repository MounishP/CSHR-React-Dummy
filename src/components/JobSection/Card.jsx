...
export default function Card({ job }) {
    return (
        <div className="bg-white card rounded-md overflow-hidden w-[250px] min-h-[300px] lg:w-auto items-center text-center content-center justify-between m-1 p-4">
            <div className="px-3 py-2">
                <div className="font-bold text-xl mb-2">{job.company.companyName}</div>
                <p className="text-gray-700 text-base h-[80px]">{job.jobTitle} </p>
            </div>
