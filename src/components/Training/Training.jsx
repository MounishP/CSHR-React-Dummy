    ...
    return (
        <section id='training' className='lg:py-4 lg:px-20 py-5 px-4 bg-blue-950'>
            <div className="m-8 text-center">
                <h1 className='text-2xl sm:text-4xl pb-4 font-bold text-yellow-500 text-center'>Trainings</h1>
            </div>
                    ...
                    <div className='w-full text-blue-950 flex flex-wrap text-center items-center content-center justify-center'>
                        {selectedButton === 'Technical' ?
                            technical.map((t, index) => (
                                <div id='service-card' className='w-36 md:w-40 lg:w-44 p-8 m-2 md:m-3 lg:m-4 rounded-xl  bg-slate-50/50 flex flex-wrap text-center items-center content-center justify-center' key={index}>
                                    <span>{t}</span>
                                </div>
                            )) :
                            nonTechnical.map((t, index) => (
                                <div id='service-card' className='lg:w-44 md:w-40 w-32 p-8 h-20 m-2 lg:m-5 rounded-xl bg-slate-50/50 flex flex-wrap text-center items-center content-center justify-center' key={index}>
